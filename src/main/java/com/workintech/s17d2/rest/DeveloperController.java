...
public class DeveloperController {
    ...
    public void init() {
        ...
        this.developers.put(1, new JuniorDeveloper(1, "kaan", 500d));
    }
    ...
    public DeveloperResponse save(@RequestBody Developer developer) {
        ...
        return new DeveloperResponse(createdDeveloper, HttpStatus.CREATED.value(), "create success!");
    }
    ...
    public DeveloperResponse getById(@PathVariable("id") int id) {
        ...
        return new DeveloperResponse(foundDeveloper, HttpStatus.OK.value(), "id search success");
    }
    ...
    public DeveloperResponse update(@PathVariable("id") int id, @RequestBody Developer developer) {
        ...
        return new DeveloperResponse(newDeveloper, HttpStatus.OK.value(), "update success");
    }
    ...
    public DeveloperResponse delete(@PathVariable("id") int id) {
        ...
        return new DeveloperResponse(removedDeveloper, HttpStatus.NO_CONTENT.value(), "delete success");
    }
